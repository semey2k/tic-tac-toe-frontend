...
class GameService {
  public async joinGame(socket: Socket, roomId: string): Promise<boolean> {
  ...
  public async gameUpdate(socket: Socket, gameMatrix: IPlayMatrix) {
    socket.emit("game_update", { matrix: gameMatrix });
  }
